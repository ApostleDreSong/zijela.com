...
<head>
  ...
  <title>Zijela...redefining web technologies</title>
  ...
  <header>
    <div class="container pt-4">
      <nav class="navbar navbar-expand-lg navbar-dark bg-transparent px-0"><a class="text-white navbar-brand"
          href="#"><img id="logo" class="img-fluid" src="images/logo.png" alt="Company Logo" /></a>
    ...
    <div class="da-home-page-text" data-aos="fade-right" data-aos-duration="1000">
      <div class="container">
        <div class="col-md-10 col-sm-12 px-0 mx-0">
          <h2 class="display-3" style="margin-left:-6px;">ZIJELA ICT</h2>
          <h3 class="h5 mt-3">Think it, Let us craft it</h3><a class="smooth-scroll btn btn-outline-light mt-4"
            href="#learn">Learn More</a>
        </div>
      </div>
    </div>
  </header>
    ...
    <div>
      <div class="da-section da-work bg-secondary" id="learn">
        <div class="container">
          ...
          <p class="px-5 pb-5 text-center text-white" data-aos="fade-up">We are a remote team of independent developers
            bringing expertise into what we do. We regularly pick up gigs which keeps us up to date with the latest
            technologies. We are always transparent in our dealings with you by giving you access to your website and other applications details while we also manage it for you incase you want to severe business with us at any time which we think you will not. Zijela is registered in Nigeria with the Corporate Affairs Commission</p>
          <div class="row">
            <div class="col-md-4">
              <div class="card mb-3" data-aos="flip-left">
                <div class="card-body mt-4 mb-1 text-center"><i class="pb-3 text-primary fas fa-briefcase fa-3x"></i>
                  ...
                  <p>Everybody we bring on board for our projects are proven developers with projects to show for it.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card mb-3" data-aos="zoom-in-up">
                <div class="card-body mt-4 mb-1 text-center"><i class="pb-3 text-primary fas fa-sliders-h fa-3x"></i>
                  ...
                  <p>We try to fit your project to your budget using the different technologies at our disposal.</p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              ...
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="500">
                    ...
                    <p>We craft your online presence to wow your customers.</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1000">
                    <div class="text-primary"><i class="pb-3 fab fa-buromobelexperte fa-3x"></i>
                      <p class="font-weight-bold">Graphic Design/Printing</p>
                    </div>
                    <p>Let us give you that beautiful outlook that you deserve.</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="2000">
                    ...
                    <p>We grow with you and your application all the way.</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="text-primary"><i class="pb-3 fas fa-cubes fa-3x"></i>
                      <p class="font-weight-bold">Software Asset Management</p>
                    </div>
                    <p>We manage and optimize the purchase, deployment, maintenance, utilization, and disposal of MICROSOFT and SAP software applications within organizations.</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                    ...
                    <p>We develop our apps primarily using Native android and React-Native frameowrk. We also design
                      using any preferred framework you ask for.</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="text-primary"><i class="pb-3 fas fa-cubes fa-3x"></i>
                      <p class="font-weight-bold">IT trainings</p>
                    </div>
                    <p>We engage in private/group/corporate trainings based on your software needs. We are basically into
                      applications software like Microsoft Office packages, Web Technologies, ERP softwares and data-analytics softwares.
                      You can be rest assured that the tutor we send to you will always give you the best delivery which
                      is in consonance with our values. Our training packages come with a digitally signed certificate that can land you your dream job.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="da-projects" id="projects">
        <div class="row mx-0">
          <div class="col-md-6 px-0 da-project-1" style="background-image: url('images/da-img-2.jpg');"
          ...
          <div class="col-md-6 pl-5 pt-5 pb-3">
            <div class="row">
              ...
              <div class="col-10">
                <div class="h4">Music</div>
                <p>Music upload and album tagging applications.</p>
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="col-10">
                ...
                <p>Student's progress tracking software and result upload application. School database software</p>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-10">
                ...
                <p>Woo-commerce wordpress setup with payment integration for websites and custom e-commerce websites for mobile.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-6 pl-5 pt-5 pb-3">
            <div class="row mb-3">
              ...
              <div class="col-10">
                ...
                <p>Loan and piggy bank applications/website.</p>
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="col-10">
                ...
                <p>Multi-level marketing and referral app/website.</p>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-10">
                ...
                <p>On demand video applications and website.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 px-0 da-project-2" style="background-image: url('images/da-img-5.jpg');"
            data-aos="zoom-in"></div>
        </div>
      </div>
      <div class="da-section bg-light" id="pricing">
        <div class="da-services">
          <div class="container text-center">
            <div class="h3 pb-5 text-center" data-aos="fade-up">Pricing/Plans</div>
            <div class="row">
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="500">
                    <div class="text-primary">
                      <p class="font-weight-bold">Basic Business website - #30,000</p>
                    </div>
                    <p>Home, About, Contact form to email, Map and description, social media integration, free 3 months maintenance service.</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1000">
                    <div class="text-primary">
                      <p class="font-weight-bold">E-commerce website - #100,000</p>
                    </div>
                    <p>Basic Business website features with shopping cart and interswitch/voguepay payment integration.</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="2000">
                    <div class="text-primary">
                      <p class="font-weight-bold">Custom Web application</p>
                    </div>
                    <p>Pricing is based on features and complexity, but we still got you covered.</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="text-primary">
                      <p class="font-weight-bold">Basic Android Application (Webview) - #50,000</p>
                    </div>
                    <p>Your full website in an android or ios app or both based on your platform preference. This includes free upload on google play store for android apps</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="text-primary">
                      <p class="font-weight-bold">Custom mobile application</p>
                    </div>
                    <p>Pricing is based on features and complexity, but we still got you covered.</p>
                  </div>
                </div>
              ...
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="text-primary">
                      <p class="font-weight-bold">Web design training - #30,000</p>
                    </div>                   
                    <p>HTML5</p>
                    <P>CSS3</P>
                    <P>BOOTSTRAP4</P>
                    <p>MATERIAL UI</p>
                    <P>INTRODUCTION TO WORDPRESS AND WEB HOSTING</P>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="text-primary">
                      <p class="font-weight-bold">JAVASCRIPT/JQUERY TRAINING - #30,000</p>
                    </div>
                    <p>ARRAYS, VARIABLES, DATA STRUCTURES AND ALGORITHMS</p>
                    <P>WEB SECURITY</P>
                    <P>WEB STORAGE</P>
              ...
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="text-primary">
                      <p class="font-weight-bold">REACT.JS/REACT-ROUTER/REDUX TRAINING - #30,000</p>
                    </div>
                    <p>STATES</p>
                    <p>PROPS</p>
                    <P>ROUTING</P>
                    <P>BUNDLING</P>
                    <p>MATERIAL UI ADVANCED TRAINING</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="text-primary">
                      <p class="font-weight-bold">PHP training - #30,000</p>
                    </div>                   
                    <p>ARRAYS, VARIABLES, DATA STRUCTURES AND ALGORITHMS</p>
                    <P>SERVER-SIDE RENDERING</P>
                    <P>FORM VALIDATIONS AND SECURITY</P>
                    <p>SERVER-SIDE PROGRAMMING</p>
                    <p>CONNECTING TO A DATABSE</p>
              ...
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="text-primary">
                      <p class="font-weight-bold">LARAVEL training - #30,000</p>
                    </div>                   
              ...
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="text-primary">
                      <p class="font-weight-bold">C#/ASP.NET TRAINING - #50,000</p>
                    </div>                    
                    <p>MVC ARCHITECTURE</p>
                    <P>ROUTING</P>
                    <P>RAZOR SYNTAX</P>
                    <p>BUILDING STRONG AND VIABLE FINANCIAL APPLICATIONS</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="text-primary">
                      <p class="font-weight-bold">DATABASE ADMINISTRATION (MSSQL, MYSQL, ORACLE, POSTGRESQL, MONGO DB) training - #50,000</p>
                    </div>                   
                    <p>INSTALLING DATABSES</p>
                    <P>CREATING TABLES</P>
                    <P>UNDERSTANDING KEYS</P>
                    <p>DATA TYPES</p>
                    <p>DATABSE SECURITY</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6">
                <div class="card mb-3">
                  <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="text-primary">
                      <p class="font-weight-bold">ANDROID APPLICAIONS training - #100,000</p>
                    </div>   
                    <P>ANDROID LIFECYCLE</P>                
                    <p>UNDERSTANDING GOOGLE APIs</p>
                    <P>JAVA AND XML COMPLETE TUTORIAL</P>
                    <p>DEPLOYING ANDROID APPLICATIONS</p>
                    <p>FIREBASE NOTIFICATIONS INTEGRATION</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="da-expertise">
        <div class="row mx-0">
          <div class="col-md-6 px-0 da-exp-image" style="background-image: url('images/da-img-6.jpg');"
            data-aos="zoom-in"></div>
          <div class="col-md-6 da-exp-skills">
            <div class="container text-uppercase">
              <h3 class="h5 mb-5">Our Expertise</h3>
              <div class="col px-0 mb-4">
                <p>Web Design and Development 90%</p>
                <div class="progress" style="height: 5px;">
                  <div class="progress-bar" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000"
              ...
              <div class="col px-0 mb-4">
                ...
                <div class="progress" style="height: 5px;">
                  <div class="progress-bar" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000"
                    role="progressbar" style="width: 85%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                  </div>
                </div>
              </div>
              <div class="col px-0 mb-4">
                <p>Graphic Design 80%</p>
                <div class="progress" style="height: 5px;">
                  <div class="progress-bar" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000"
                    role="progressbar" style="width: 90%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                  </div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="card d-block mb-3">
                      ...
                      <div class="card-body text-center">
                        <div class="h5">Damilare Ademeso</div>
                        <p class="text-muted">CEO</p>
                        <p class="text-muted">Javascript/Jquery/React.JS/PHP/LARAVEL/Android/React-Native/SAP ABAP</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    <div class="card d-block mb-3">
                      <!--   <img class="card-img-top" src="#" alt="image"/>  -->
                      <div class="card-body text-center">
                        <div class="h5">Oluwatosin Pelumi</div>
                        <p class="text-muted">Python/Data analytics specialist</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="card d-block mb-3">
                      <!--   <img class="card-img-top" src="#" alt="image"/>  -->
                      <div class="card-body text-center">
                        <div class="h5">Olamide </div>
                        <p class="text-muted">Snr Graphics Designer</p>
                      </div>
                    </div>
                  </div>
                </div>
...
-->
      <div class="da-section">
        <div class="container da-company-brand py-5">
          ...
          <div class="row">
            <div class="col-md-3 text-center"><img class="img-fluid" src="images/company-1.jpg" alt="Company Image 1" />
            </div>
            <div class="col-md-3 text-center"><img class="img-fluid" src="images/company-2.jpg" alt="Company Image 2" />
            </div>
            <div class="col-md-3 text-center"><img class="img-fluid" src="images/company-3.jpg" alt="Company Image 3" />
            </div>
            <div class="col-md-3 text-center"><img class="img-fluid" src="images/company-4.jpg" alt="Company Image 4" />
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <div class="row justify-content-center">
                  <div class="col-md-8">
                    <p>"Zijela helped us to set up our online training faculty and database at the speed of light."</p>
                    <div class="h6 text-uppercase">Eburuche Obinna Banito, IIPM</div>
                  </div>
                </div>
              </div>
              <div class="carousel-item">
                <div class="row justify-content-center">
                  <div class="col-md-8">
                    <p>"Zijela helped us craft a custom wordpress theme for our magazine website at relatively low cost."</p>
                    <div class="h6 text-uppercase">Lanre Alabi, Infrastructure Development Magazine</div>
                  </div>
                </div>
              </div>
              <div class="carousel-item">
                <div class="row justify-content-center">
                  <div class="col-md-8">
                    <p>"What I love most about Zijela ICT is their email and whatsapp customer support. It is simply superb and prompt."</p>
                    <div class="h6 text-uppercase">Manbake foods</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="container">
            <div class="card py-4 px-4">
              ...
              <div class="row">
                <div class="col-md-7 col-sm-12 mb-3">
                  <div class="da-contact-message">
                    <form action=" " method="POST">
                      ...
                      <div class="row mb-3">
                        <label>Hey, what is 2+2?</label>
                        <div class="col">
                            <input id="captcha" class="form-control" type="number" name="captcha" placeholder="*Answer is 4. Type it here"
                            required="required" onkeyup="releaseButton()" onkeydown="releaseButton()"/>
                            <script>
                ...
                <div class="col-md-5">
                  <p>Why not talk to us on any of these platforms. Our e-mail and whatsapp channels are available 24/7</p>
                  <p><b>Phone:</b> +234 8182818327</p>
                  <p><b>Email:</b> support@zijela.com</p>
                  <p><b>Whatsapp:</b> +234 8136776626</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="container text-white">
      <div class="row">
        <div class="col-md-4">
          ...
          <p class="mb-0">support@zijela.com</p>
          <p>+234 8136776626</p>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
          ...
          <p>&copy; 2018 ZIJELA ICT. All rights reserved.</p>
